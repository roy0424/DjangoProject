...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='JtFoodBrandBrandFood',
            fields=[
                ('foodid', models.PositiveIntegerField(db_column='Foodid', primary_key=True, serialize=False)),
                ('brandid', models.PositiveIntegerField(db_column='Brandid')),
            ],
            options={
